...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Hanoi2) (read-case-sensitive #t) (teachpacks ((lib "Teachpack_hanoi.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #t ((lib "Teachpack_hanoi.ss" "installed-teachpacks")) #f)))
; n=numero di dischi
; k=numero mossa
